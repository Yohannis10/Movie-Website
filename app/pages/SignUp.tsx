...
import { Mail, Lock, User, Eye, EyeOff, Facebook, Apple } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-red-900 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="text-gray-400 mt-2">Join millions of viewers worldwide</p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 bg-gray-800 border rounded-lg focus:outline-none focus:ring-2 transition-colors ${
                    errors.name ? 'border-red-500 focus:ring-red-500' : 'border-gray-700 focus:ring-red-600'
                  }`}
                />
              </div>
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full pl-10 pr-12 py-3 bg-gray-800 border rounded-lg focus:outline-none focus:ring-2 transition-colors ${
                    errors.confirmPassword ? 'border-red-500 focus:ring-red-500' : 'border-gray-700 focus:ring-red-600'
                  }`}
                />
                <button
                  type="button"
          ...
          <div className="flex items-start">
            <input
              type="checkbox"
              className="mt-1 rounded bg-gray-800 border-gray-700 text-red-600 focus:ring-red-600"
              required
            />
